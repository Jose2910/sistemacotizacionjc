    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar bg-white elevation-4">
            ...
            <a href="<?php echo base_url; ?>admin" class="brand-link">
                <img src="<?php echo base_url; ?>Assets/img/lglocal.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Sistema Cotización</span>
            </a>

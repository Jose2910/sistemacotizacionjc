                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input id="precio_compra" class="form-control" type="number" step="any" min="0.01" name="precio_compra" placeholder="Precio Compra" required>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="precio_venta">Precio Venta</label>
                                <input id="precio_venta" class="form-control" type="number" step="any" min="0.01" name="precio_venta" placeholder="Precio Venta" required>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="card border-primary">
                                    <div class="card-body text-center">
                                        <label for="imagen" id="icon-image">
                                            <img class="img-thumbnail" id="img-preview" src="<?php echo base_url; ?>Assets/img/lglocal.png" width="200">
                                        </label>

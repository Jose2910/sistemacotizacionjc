    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="#" class="h1"><b>Sistema</b> Cotizacion</a>
                <img class="img-thumbnail" src="<?php echo base_url; ?>Assets/img/lglocal.png" width="150">
            </div>
            <div class="card-body">
                <form id="frmLogin" onsubmit="frmLogin(event)">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" id="btnAccion">Iniciar</button>
                </form>
            </div>
            <!-- /.card-body -->
        </div>
